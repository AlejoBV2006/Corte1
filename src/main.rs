...
impl Default for ProgramApp{
    fn default() -> Self {
        ...
        let games: Vec<(String, bool)> = vec![
            ...
            ("Un jugador".to_string(), false),
            ("Rol".to_string(), false),
            ("Estrategia".to_string(), false),
            ("2D".to_string(), false),
            ("Acceso anticipado".to_string(), false),
            ("Free to Play".to_string(), false),
            ("3D".to_string(), false),
            ("Ambientales".to_string(), false),
            ("Coloridos".to_string(), false),
            ("Buena Trama".to_string(), false),
            ...
            ("Primera Persona".to_string(), false),
            ("Combate".to_string(), false),
            ("Accion y Aventura".to_string(), false),
